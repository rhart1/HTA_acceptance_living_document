...
<style>
    ...
    .HTAtable tr:nth-child(`r which(CountryVec == "Italy")`) td:nth-child(3) { background: `r yellowhex`;color:black; }
    .HTAtable tr:nth-child(`r which(CountryVec == "Italy")`) td:nth-child(5) { background: `r yellowhex`;color:black; }
